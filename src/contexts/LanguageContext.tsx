...
const translations = {
  en: {
    ...
    "hero.description":
      "AWS Certified Engineer crafting innovative web solutions from Japan. Specializing in cloud architecture, modern web design & web development, and scalable applications.",
    ...
    "about.description":
      "Currently working as a Cloud Engineer in Japan, I bring together my expertise in AWS cloud services and full-stack development to create impactful digital experiences.",
  ...
  ja: {
    ...
    "hero.description":
      "AWS認定エンジニアとして日本からイノベーティブなWebソリューションを提供。クラウドアーキテクチャ、モダンwebデザイン&Web開発、スケーラブルアプリケーションが専門です。",
    ...
    "about.description":
      "現在日本でクラウドエンジニアとして働いており、AWSクラウドサービスとフルスタック開発の専門知識を組み合わせて、インパクトのあるデジタル体験を創造しています。",
