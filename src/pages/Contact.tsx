...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        title:
          language === "en" ? "Message sent!" : "メッセージが送信されました！",
        description:
          language === "en"
            ? "Thank you for your message. I'll get back to you soon!"
            : "メッセージありがとうございます! 早めにお返事いたします！",
      });
  ...
  const contactInfo = [
    {
      ...
      value: "mohanbabujii.official@gmail.com",
    ...
    },
    {
      ...
      value:
        language === "en" ? "Available for projects" : "プロジェクト受付中",
      href: null,
    },
  ];
  ...
  const projectTypes = [
    {
      value: "",
      label:
        language === "en" ? "Select project type" : "プロジェクトタイプを選択",
    },
    {
      value: "web-development",
      label: language === "en" ? "Web Design" : "Webデザイン",
    },
    {
      value: "cloud-architecture",
      label:
        language === "en" ? "Cloud Architecture" : "クラウドアーキテクチャ",
    },
    {
      value: "consulting",
      label: language === "en" ? "Portfolio Development" : "ポートフォリオ開発",
    },
    {
      value: "fullstack",
      label:
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        language === "en"
          ? "Absolutely! I work with clients globally and am comfortable with remote collaboration across different time zones. My Trilingual skills (English/Japanese/Tamil) are particularly valuable for international projects."
          : "もちろんです！世界中のクライアントと協力し、異なるタイムゾーンでのリモートコラボレーションに慣れています。私の三か国語スキル（英語/日本語/タミル語）は特に国際プロジェクトで価値があります。",
    },
    {
      question:
        language === "en"
      ...
      answer:
        language === "en"
          ? "I specialize in cloud services (specifically AWS), Figma, Adobe for Web Design, React/TypeScript for frontend, Node.js/Python for backend, and DevOps practices. I am also experienced with serverless architectures and modern deployment pipelines."
          : "クラウドサービス(特にAWS)、WebデザインのFigmaやAdobeなど、フロントエンドのReact/TypeScript、バックエンドのNode.js/Python、DevOpsプラクティスを専門としています。サーバーレスアーキテクチャと最新のデプロイメントパイプラインの経験もあります。",
    },
  ];
