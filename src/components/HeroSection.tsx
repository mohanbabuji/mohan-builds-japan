      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full">
        <div className="text-center">
          ...
          <div className="animate-fade-up">
            <h1 className="text-hero mb-8 select-none">
              {t('hero.title')}
            </h1>
          </div>
          ...
          {/* Description */}
          <div className="animate-fade-up max-w-2xl mx-auto mb-16" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Minimal CTA Buttons */}
          <div className="animate-fade-up flex flex-col sm:flex-row items-center justify-center gap-6 mb-20" style={{ animationDelay: '0.3s' }}>
            <Link to="/works">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-200 max-w-4xl mx-auto">
              {[
                ...
                <div key={tag} className="bg-white px-6 py-4 text-center">
                  <span className="text-xs font-medium tracking-widest uppercase text-gray-600">{tag}</span>
                </div>
              ))}
            </div>
          </div>
